...
JDBC jdbc = new JDBC();
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/png/icons8-hand-with-pen-50.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String courseID = jTextField1.getText();
        ...
        String tutorID = jTextField5.getText();
        
        
        jdbc.putData("INSERT INTO course_details(CourseID,SubjectID,Grade,TutorID)VALUES('"+courseID+"','"+subjectID+"','"+grade+"','"+tutorID+"')");
        jdbc.putData("INSERT INTO subject_details(SubjectID,SubjectName)VALUES('"+subjectID+"','"+subjectName+"')");
